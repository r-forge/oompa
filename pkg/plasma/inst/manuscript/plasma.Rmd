---
title: "plasma: Partial LeAst Squares for Multi-omics Analysis (manuscript ver)"
...
xmaf <- shrink(cmaf, 4)
heat(xmaf, cexCol = 0.9, cexRow = 0.5, col = HG)
```
...
xmeth <- shrink(meth, 4)
heat(xmeth, cexCol = 0.9, cexRow = 0.5, col = HG)
```
