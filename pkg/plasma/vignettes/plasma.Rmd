...
MOFA starts with a standard method -- Latent Ffactor Analysis -- that is known to work 
...
(`plsr' Version 'r packageVersion(plsr)` [CITE]) to learn how to predict the coefficients of
